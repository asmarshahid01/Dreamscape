...
export default function SignUp() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.post("http://localhost:8080/api/user/signup",{username,password,genderSelected},{withCredentials:true});
      console.log(response); // Assuming the server returns some data upon successful signup
